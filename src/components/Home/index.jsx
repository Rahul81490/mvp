    ...
    return (
        <div className="min-h-screen bg-gray-100 flex flex-col">
            ...
            <div className="flex flex-grow justify-center items-center relative">
                ...
                <div className="container mx-auto text-center text-white relative z-10 px-4 md:px-8"> {/* Added px-4 for smaller screens and md:px-8 for medium and larger screens */}
                    <div className="py-20">
